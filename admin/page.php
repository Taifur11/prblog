    ...
    <table class="form">
		...
		<tr>
            ...
            <td>
                ...
                <span class="actiondel"><a <a onclick="return confirm('Are you sure to DELETE?');" href="deletepage.php?delpage=<?php echo $result['id'];?>">Delete</a></span>
            </td>
        </tr>
    </table>
    </form>
