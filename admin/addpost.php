...
if($_SERVER['REQUEST_METHOD']=='POST'){
	...
	elseif ($file_size >1073741824) {
     echo "<span style='color:red;'>File Size Must Not Be larger Than 1MB!!</span>";
    }
    ...
    if ($inserted_rows) {
     echo "<span style='color:green;'>Post Inserted Successfully.
     </span>";
    }else {
     echo "<span style='color:red;'>Post Not Inserted !</span>";
    }
    }
   }
...
<?php }}?>                                  
						...
						<tr>
                            ...
                            <td>
                                <input type="text" placeholder="Enter Post Title..." class="medium" name="author" />
                            </td>
                        </tr>
						<tr>
                            <td>
